...
import HoverButton from '../shared/General/HoverButton'
	...
	render () {
		...
		return (
			<div className="work-page-wrapper">
				<div style={{ backgroundImage: this.props.background ? `url(${this.props.backgroundImage})` : null }}
					 className="work-page-section center-text gradient">
					...
					<div className="work-page-text-wrapper center-text">
						<div data-aos="fade" data-aos-anchor-placement="top" data-aos-delay="300">
							...
							<ImageFont title="Deliverytracker" image={Image}/>
