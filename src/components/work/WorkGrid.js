...
import Building from "../../assets/images/work/building.jpg";
import BuildingOverlay from "../../assets/images/work/building-overlay.png"
		...
		return (
			<div className="work-grid-wrapper">
				<div className="work-card-wrapper">
					<WorkCard logo={Nike} background={Building} backgroundOverlay={BuildingOverlay}  alt="Nike-logo" client="Nike" title="Product design"/>
