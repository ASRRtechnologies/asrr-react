			...
			<div ref={this.header} className="navigation-container">
				<div className="navigation-wrapper">
					...
					<div className={this.state.menuOpen ? "menu-open navigation-menu top" : "navigation-menu"}>
						...
						<div className={this.state.menuOpen ? "menu-open menu-overlay top" : "menu-overlay top"}/>
						<div
							className={this.state.menuOpen ? "menu-open menu-overlay middle" : "menu-overlay middle"}/>
						<div
							className={this.state.menuOpen ? "menu-open menu-overlay bottom" : "menu-overlay bottom"}/>
					</div>
